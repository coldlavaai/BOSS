    ...
    try {
      ...
      const { data: newService, error: createError } = await supabase
        ...
        .insert({
          ...
          duration_text: durationText.trim() || `${durationMinutes} minutes`,
          ...
          includes: [],
          notes: null,
          default_coating_years: null,
          warranty_years: null,
          remote_bookable: true,
      ...
      const pricingRecords = sizes.map(({ size, price }) => {
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new service to your catalog with pricing
          </DialogDescription>
        </DialogHeader>
